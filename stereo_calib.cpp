...
void future_sterecalib(bool useCalibrated ,Mat rmap[][2],Rect validRoi[]);
...
// IF BY CALIBRATED (BOUGUET'S METHOD)
    ...
    future_sterecalib( false,rmap,validRoi);
}
...
void future_sterecalib(bool useCalibrated,Mat rmap[][2],Rect validRoi[]){
    ...
    string imagelistfn = "stereo_pro.xml";  
    vector<string> goodImageList;
